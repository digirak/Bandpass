...
blacknutt=0.3635819-0.4891775.*cos(2*pi.*[1:N]/(N))+0.1365995.*cos(4*pi.*[1:N]/(N))-0.0106411.*cos(6*pi.*[1:N]/(N))
%parpool(2)
...
for i=1:base_lims%%loop over u
	terme(:,i,i)=exp(numer(:,i,i)./denom(:,i))
end
for i=1:base_lims
expterm(:,i,i)=terme(:,i,i)*term3(:,i)
end
for i=1:base_lims
parfor j=1:N
